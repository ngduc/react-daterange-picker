...
var _CalendarDateDuc = require('./calendar/CalendarDateDuc');

var _CalendarDateDuc2 = _interopRequireDefault(_CalendarDateDuc);
...
var DateRangePicker = _react2.default.createClass({
  ...
  propTypes: {
    ...
    dateRenderer: _react2.default.PropTypes.func
  },
  ...
  renderCalendar: function renderCalendar(index) {
    ...
    props = {
      ...
      dateComponent: _CalendarDateDuc2.default,
